 ...
 */
export const getAllUserTransactionsByUserId = <ThrowOnError extends boolean = false>(options: Options<GetAllUserTransactionsByUserIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAllUserTransactionsByUserIdResponse, GetAllUserTransactionsByUserIdError, ThrowOnError>({
        url: '/user/{id}/renting-transactions',
        ...options
    });
};
...
export const getAllCategories = <ThrowOnError extends boolean = false>(options?: Options<GetAllCategoriesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllCategoriesResponse, GetAllCategoriesError, ThrowOnError>({
