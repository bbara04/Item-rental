...
import UniRentLogo from "../../assets/UniRent_Logo.png";
import { loginByBasic } from "../../client";
import useResponsiveWidth from "../../hooks/useResponsiveWidth"; // Added
import { breakpoints } from "../../utils/breakpoints"; // Added
...
const LoginPanel: FC = () => {
  ...
  const width = useResponsiveWidth(); // Added
  ...
  return (
    <div className="flex h-full items-center justify-center bg-gray-100">
      <div
        className={`flex ${
          width < breakpoints.md ? "flex-col space-y-6 p-6" : "flex-row space-x-16 p-12"
        } items-center bg-white rounded-lg shadow-lg`}
      >
        <img
          src={UniRentLogo}
          alt="Logo"
          className={width < breakpoints.md ? "h-32" : "h-56 mb-8"} />
        <div>
