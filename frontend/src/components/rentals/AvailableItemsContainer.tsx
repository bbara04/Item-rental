...
const mockRentalItems: (PreviewRentalItem)[] = [
    {
        id: 1,
    ...
    },
    {
        ...
        imageUrl:
            "https://th.bing.com/th?id=OPEC.ml3N02wpmCW%2f7g474C474&w=200&h=150&rs=1&o=5&pid=21.1p",
        available: 6,
        description:
...
const AvailableItemsContainer = () => {
    ...
    const filteredItems = mockRentalItems.filter(
        (item) =>
